...
void InitUgcQueryTypes(Napi::Env env, Napi::Object exports)
{
    ...
    (ugc_query_type)
        .Set("AcceptedForGameRankedByAcceptanceDate",
             Napi::Number::New(env, k_EUGCQuery_AcceptedForGameRankedByAcceptanceDate));
    (ugc_query_type).Set("RankedByTrend", Napi::Number::New(env, k_EUGCQuery_RankedByTrend));
    (ugc_query_type)
        .Set("FavoritedByFriendsRankedByPublicationDate",
             Napi::Number::New(env, k_EUGCQuery_FavoritedByFriendsRankedByPublicationDate));
    (ugc_query_type)
        .Set("CreatedByFriendsRankedByPublicationDate",
             Napi::Number::New(env, k_EUGCQuery_CreatedByFriendsRankedByPublicationDate));
    (ugc_query_type).Set("RankedByNumTimesReported", Napi::Number::New(env, k_EUGCQuery_RankedByNumTimesReported));
    (ugc_query_type)
        .Set("CreatedByFollowedUsersRankedByPublicationDate",
             Napi::Number::New(env, k_EUGCQuery_CreatedByFollowedUsersRankedByPublicationDate));
...
void InitUserUgcListSortOrder(Napi::Env env, Napi::Object exports)
{
    ...
    (ugc_list_sort_order)
        .Set("CreationOrderDesc", Napi::Number::New(env, static_cast<int>(k_EUserUGCListSortOrder_CreationOrderDesc)));
    ...
    (ugc_list_sort_order)
        .Set("SubscriptionDateDesc", Napi::Number::New(env, k_EUserUGCListSortOrder_SubscriptionDateDesc));
