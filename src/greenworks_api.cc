...
#define THROW_BAD_ARGS(msg)    \
	...
	{
		// Common APIs.
		exports->Set(Nan::New("initAPI").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(InitAPI)->GetFunction());
		exports->Set(Nan::New("getSteamId").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(GetSteamId)->GetFunction());
		exports->Set(Nan::New("runCallbacks").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(RunCallbacks)->GetFunction());

		// File related APIs.
		exports->Set(Nan::New("saveTextToFile").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(SaveTextToFile)->GetFunction());
		exports->Set(Nan::New("readTextFromFile").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(ReadTextFromFile)->GetFunction());
		exports->Set(Nan::New("saveFilesToCloud").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(SaveFilesToCloud)->GetFunction());

		// Cloud related APIs.
		exports->Set(Nan::New("isCloudEnabled").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(IsCloudEnabled)->GetFunction());
		exports->Set(Nan::New("isCloudEnabledForUser").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(
				IsCloudEnabledForUser)->GetFunction());
		exports->Set(Nan::New("enableCloud").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(EnableCloud)->GetFunction());
		exports->Set(Nan::New("getCloudQuota").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(GetCloudQuota)->GetFunction());

		// Achievement related APIs.
		exports->Set(Nan::New("activateAchievement").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(
				ActivateAchievement)->GetFunction());
		exports->Set(Nan::New("clearAchievement").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(ClearAchievement)->GetFunction());
		exports->Set(Nan::New("getAchievement").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(GetAchievement)->GetFunction());
		exports->Set(Nan::New("getAchievementNames").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(GetAchievementNames)->GetFunction());
		exports->Set(Nan::New("getNumberOfAchievements").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(
				GetNumberOfAchievements)->GetFunction());

		// Game related APIs.
		exports->Set(Nan::New("getCurrentBetaName").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(
				GetCurrentBetaName)->GetFunction());
		exports->Set(Nan::New("getCurrentGameLanguage").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(
				GetCurrentGameLanguage)->GetFunction());
		exports->Set(Nan::New("getCurrentUILanguage").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(
				GetCurrentUILanguage)->GetFunction());
		exports->Set(Nan::New("getCurrentGameInstallDir").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(
				GetCurrentGameInstallDir)->GetFunction());
		exports->Set(Nan::New("getNumberOfPlayers").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(GetNumberOfPlayers)->GetFunction());
		exports->Set(Nan::New("isGameOverlayEnabled").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(
				IsGameOverlayEnabled)->GetFunction());
		exports->Set(Nan::New("activateGameOverlay").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(
				ActivateGameOverlay)->GetFunction());
		exports->Set(Nan::New("activateGameOverlayToWebPage").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(
				ActivateGameOverlayToWebPage)->GetFunction());
		exports->Set(Nan::New("onGameOverlayActive").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(
				OnGameOverlayActive)->GetFunction());
		exports->Set(Nan::New("onGameJoinRequested").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(
				OnGameJoinRequested)->GetFunction());

		// Workshop related APIs
		exports->Set(Nan::New("fileShare").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(FileShare)->GetFunction());
		exports->Set(Nan::New("publishWorkshopFile").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(PublishWorkshopFile)->GetFunction());
		exports->Set(Nan::New("updatePublishedWorkshopFile").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(
				UpdatePublishedWorkshopFile)->GetFunction());
		exports->Set(Nan::New("ugcGetItems").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(UGCGetItems)->GetFunction());
		exports->Set(Nan::New("ugcGetUserItems").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(UGCGetUserItems)->GetFunction());
		exports->Set(Nan::New("ugcDownloadItem").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(UGCDownloadItem)->GetFunction());
		exports->Set(Nan::New("ugcSynchronizeItems").ToLocalChecked(),
			Nan::New<v8::FunctionTemplate>(UGCSynchronizeItems)->GetFunction());
		exports->Set(Nan::New("ugcShowOverlay").ToLocalChecked(),
