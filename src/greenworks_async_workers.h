...
class GetNumberOfPlayersWorker : public SteamCallbackAsyncWorker
{
  public:
    ...
    void OnGetNumberOfPlayersCompleted(NumberOfCurrentPlayers_t *result, bool io_failure);
    // Override NanAsyncWorker methods.
    virtual void Execute() override;
    virtual void OnOK() override;
...
{
  public:
    CreateArchiveWorker(Napi::Function &callback, const std::string &zip_file_path, const std::string &source_dir,
                        const std::string &password, int compress_level);
...
{
  public:
    ExtractArchiveWorker(Napi::Function &callback, const std::string &zip_file_path, const std::string &extract_path,
...
class StoreUserStatsWorker : public SteamCallbackAsyncWorker
{
  public:
    ...
    STEAM_CALLBACK(StoreUserStatsWorker, OnUserStatsStored, UserStatsStored_t, result);
